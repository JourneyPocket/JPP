      ...
      <div class="col-lg-12 position-relative z-index-2">
        ...
        <div class="row mb-4">
          <div class="col-lg-4 col-md-6 mt-4 mb-4">
            <chart-holder-card
              ...
              subtitle="Detailed Monthly Revenue Analysis"
          ...
          <div class="col-lg-4 col-md-6 mt-4 mb-4">
            <chart-holder-card
              title="Monthly Consume"
              subtitle="Detailed Monthly Consume Analysis"
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <mini-statistics-card
              :title="{ text: 'Housing Expense', value: '₩300,000' }"
              detail="<span class='text-success text-sm font-weight-bolder'>+55%</span> than last month"
              :icon="{
                name: 'weekend',
                color: 'text-white',
                background: 'dark',
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Food Expense', value: '₩400,000' }"
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Transportation Expense', value: '₩100,000' }"
              detail="<span class='text-success text-sm font-weight-bolder'>+1%</span> than last month"
              :icon="{
                name: 'leaderboard',
                color: 'text-white',
                background: 'success',
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Leisure / Fasion Expense', value: '₩500,000' }"
              detail="<span class='text-success text-sm font-weight-bolder'>+10%</span> than last month"
              :icon="{
                name: 'leaderboard',
                color: 'text-white',
                background: 'primary',
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4 col-md-6">
            <booking-card
              :img="booking3"
              title="Beautiful Resort with Swimming Pool"
              description="The
            place is close to Metro Station and bus stop just 2 min by walk and
            near to 'Naviglio' where you can enjoy the night life in London,
            UK."
