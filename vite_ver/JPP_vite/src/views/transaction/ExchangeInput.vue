              ...
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                  <form role="form" class="text-start mt-3">
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col">
                            <label for="toCountrySelection">To Country</label>
                            <select name="toCountrySelection" class="form-select border ps-2" v-model="selectedToCountry" >                    
                                <option class="ms-3" v-for="countryType in countryTypes" :key="countryType" :value="countryType" selected>{{ countryType }}</option>
                            </select>
                        </div>          
                        <div class="mb-3 col">
